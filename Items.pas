...
Items.Set(SCULPTURE,     Item ('A LARGE SCULPTURE',            'SCU', LOBBY));
Items.Set(BUILDING,      Item ('A TALL OFFICE BUILDING',       'BUI', BUSY_STREET));
Items.Set(SLIDING_DOORS, Item ('A PAIR OF SLIDING DOORS',      'DOO', LOBBY));
...
Items.Set(BADGE,         Item ('A C.I.A. IDENTIFICATION BADGE','BAD', INVENTORY));
